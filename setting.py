...
def get_setting():
    ...
    parser.add_argument('--source_domain', type=str, default='dslr',help='Source domain')
    parser.add_argument('--target_domain', type=str, default='webcam',help='Target domain')
    ...
    parser.add_argument('--num_epochs', type=int, default=600, help='Total number of training epochs')
